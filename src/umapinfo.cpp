...
// This is specification 1.4-RZ signifying a slight deviation
// in the specs.
// I use the InterMusic for both the intermission and the intertext
// I like it better this way and gives users the opportunity
// to change the music for both.
