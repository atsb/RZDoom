...
public:
    ...
    void DrawTextureV(FTexture* img, double x, double y, uint32 tag, va_list tags);
...
#define D3DFVF_FBVERTEX (D3DFVF_XYZRHW | D3DFVF_DIFFUSE | D3DFVF_SPECULAR | D3DFVF_TEX1)
    ...
    enum { PSCONST_Desaturation = 1, PSCONST_PaletteMod = 2, PSCONST_Weights = 6, PSCONST_Gamma = 7 };
